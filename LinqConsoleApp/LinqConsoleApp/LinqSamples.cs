    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad3()
        {
            ...
            var max2 = Emps.Max(emp => emp.Salary);
        ...
        public void Przyklad4()
        {
            ...
            var res2 = Emps.Where(emp => emp.Salary == Emps.Max(emp1 => emp1.Salary));
        ...
        {
            //Jednego pracownika brakuje, ponieważ u niego deptno jest null, ale w zadaniu nie jest powiedziane, żebyśmy użyli left join
            var res = from emp in Emps
        ...
        public void Przyklad9()
        {
            ...
            var res2 = Emps.Where(emp => emp.Job == "Frontend programmer").OrderByDescending(emp => emp.HireDate).FirstOrDefault();
        ...
        {
            var res = (from emp in Emps
                       select emp).Aggregate((res, next) => next.Salary > res.Salary ? next : res);
        ...
        {
            ///Nie jestem pewny, czy w Query syntax też muszę wykorzystać SelectMany przy pomocy rozwiązania hybrydowego
            ///da się zrobić CROSS JOIN bez tego, ale zostawiam komentarz żeby pokazać, że wiem jak to zrobić

            /*  var res = (from emp in Emps
                         select emp).SelectMany(other => Depts, (emp, dept) => new
                         {
                             emp,
                             dept
                         });*/
            ...
            var res2 = Emps.SelectMany(other => Depts, (emp,dept) => new 
            { 
            emp,
            dept
            });
